...
// uint64 userId = 2;
inline void SC_LOGIN::clear_userid() {
  _impl_.userid_ = uint64_t{0u};
}
inline uint64_t SC_LOGIN::_internal_userid() const {
  return _impl_.userid_;
}
inline uint64_t SC_LOGIN::userid() const {
  // @@protoc_insertion_point(field_get:Protocol.SC_LOGIN.userId)
  return _internal_userid();
}
inline void SC_LOGIN::_internal_set_userid(uint64_t value) {
  
  _impl_.userid_ = value;
}
inline void SC_LOGIN::set_userid(uint64_t value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:Protocol.SC_LOGIN.userId)
}
